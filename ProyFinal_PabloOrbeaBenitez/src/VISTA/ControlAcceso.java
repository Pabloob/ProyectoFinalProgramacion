...
public class ControlAcceso {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            String nombre = LIBRERIAS.Leer.leerCadenaNoVacía("Introduce el nombre: ");
            String contraseña = LIBRERIAS.Leer.leerCadenaNoVacía("Introduce la contraseña: ");
            ...
            if (gestorUsuarios.comprobarInicioSesion(nombre, contraseña)) {
                ...
                ventanaProductos.setAdministrador(gestorUsuarios.comprobarUsuarioAdministrador(nombre));
                ventanaProductos.setNombreUsuario(nombre);
